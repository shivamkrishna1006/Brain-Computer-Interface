# 🧠 Brain-Computer Interface: Real-Time EEG Motor Imagery Control
...
A production-ready **Brain-Computer Interface (BCI)** system for real-time EEG-based motor imagery classification. Uses a CNN-LSTM deep learning architecture achieving **71.47% accuracy** on 5-class motor imagery tasks with a web dashboard and real-time inference engine.

**[📚 Full Documentation](./mdfiles)** • **[🚀 Quick Start](#quick-start)** • **[📖 Complete README](./mdfiles/README.md)**

---

## 🌟 Features

- ✅ **Real-Time EEG Classification** - <500ms latency inference
- ✅ **5-Class Motor Imagery** - Left/Right Hand, Both Hands, Both Feet, Tongue/Click
- ✅ **CNN-LSTM Architecture** - Production-tested deep learning model
- ✅ **Web Dashboard** - Flask + Socket.IO real-time visualization
- ✅ **Interactive Charts** - Chart.js with 5 real-time visualizations
- ✅ **RESTful API** - 4 endpoints + 8+ WebSocket events
- ✅ **Docker Ready** - Multi-stage builds with GPU support
- ✅ **Fully Documented** - 44+ guides and references
- ✅ **Configuration-Driven** - YAML-based settings for all environments
...
### Core BCI System
- **Training Pipeline** - `train.py` with callbacks, early stopping, checkpointing
- **Real-Time Inference** - `realtime.py` with <500ms latency
- **Model Management** - Save/load/validate trained models
- **Configuration System** - Flexible YAML + environment variables

### Web Application
- **Flask Backend** - 4 REST endpoints, 8+ WebSocket events
- **Real-Time Dashboard** - Socket.IO with live updates
- **EEG Visualization** - 5 Chart.js charts for real-time display
- **Model Predictions** - Confidence scores and probability distribution
...
```bash
# 1. Clone repository
git clone https://github.com/yourusername/BCI_INTERFACE.git
cd BCI_INTERFACE
...
All documentation is organized in the `mdfiles/` folder. Key guides:

- **[README.md](./mdfiles/README.md)** - Complete project documentation
- **[QUICKSTART.md](./mdfiles/QUICKSTART.md)** - 5-minute setup
- **[TRAINING_GUIDE.md](./mdfiles/TRAINING_GUIDE.md)** - Model training
- **[DEPLOYMENT_GUIDE.md](./mdfiles/DEPLOYMENT_GUIDE.md)** - Production deployment
- **[CONFIGURATION_GUIDE.md](./mdfiles/CONFIGURATION_GUIDE.md)** - Configuration options
- **[REALTIME_INFERENCE_GUIDE.md](./mdfiles/REALTIME_INFERENCE_GUIDE.md)** - Real-time setup
- **[DATA_PREPARATION_GUIDE.md](./mdfiles/DATA_PREPARATION_GUIDE.md)** - Data setup
- **[PHYSIONET_GUIDE.md](./mdfiles/PHYSIONET_GUIDE.md)** - PhysioNet dataset
- **[EVALUATION_GUIDE.md](./mdfiles/EVALUATION_GUIDE.md)** - Model evaluation

**[🔗 Full Documentation Index](./mdfiles/DOCUMENTATION_INDEX.md)**
...
```
BCI_INTERFACE/
├── mdfiles/                      # Documentation (44+ guides)
├── webapp/                       # Web application
│   ├── backend/                 # Flask API
│   ├── frontend/                # Dashboard HTML/CSS/JS
│   └── md files/               # Webapp-specific docs
├── src/                         # Source code
...
**CNN-LSTM Hybrid** for motor imagery EEG classification:

```
Input (8 channels, 1000 samples)
  ↓
...
All options documented in [CONFIGURATION_GUIDE.md](./mdfiles/CONFIGURATION_GUIDE.md)
...
# Run specific test
python -m pytest tests/test_training_module.py
...
### Cloud (AWS/GCP/Azure)
See [DEPLOYMENT_GUIDE.md](./mdfiles/DEPLOYMENT_GUIDE.md)
...
1. **Read** [CONTRIBUTING.md](./mdfiles/CONTRIBUTING.md)
...
See [REQUIREMENTS_CHECKLIST.md](./mdfiles/REQUIREMENTS_CHECKLIST.md) for complete list.
...
- **BCI Interface Team** - Initial development
- **Contributors** - See [CONTRIBUTING.md](./mdfiles/CONTRIBUTING.md)
...
### Papers
- Krizhevsky et al. (2012) - ConvNets
- Hochreiter & Schmidhuber (1997) - LSTM
- Stoll et al. (2018) - EEG Motor Imagery
...
- [PhysioNet EEG Database](https://physionet.org/)
...
A: This is research code. For medical use, consult healthcare professionals and comply with regulations.

**Q: What EEG hardware is supported?**
A: The system uses standard EEG formats. See [DATA_PREPARATION_GUIDE.md](./mdfiles/DATA_PREPARATION_GUIDE.md).

**Q: How do I improve accuracy?**
A: See [TRAINING_GUIDE.md](./mdfiles/TRAINING_GUIDE.md) for optimization techniques.

**Q: Where's the full documentation?**
A: All 44+ guides are in the [mdfiles/](./mdfiles) folder. Start with [README.md](./mdfiles/README.md).
...
- **Documentation** - Check [mdfiles/](./mdfiles) first
...
- [ ] Hardware integration (OpenBCI, etc.)
...
1. [Quick Start](./mdfiles/QUICKSTART.md) - 5 minutes
2. [Training Guide](./mdfiles/TRAINING_GUIDE.md) - Build your model
3. [Deployment Guide](./mdfiles/DEPLOYMENT_GUIDE.md) - Go to production
4. [Full Documentation](./mdfiles) - Everything else
